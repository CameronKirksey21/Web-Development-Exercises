...
app.get('/filter', (req, res) => {
  ...
  const filteredJokes = jokes.filter((joke) => joke.jokeType === queryParam);
...
app.put('/jokes/:id', (req, res) => {
  ...
  const foundJokeIndex = jokes.findIndex((joke) => joke.id === pathId);
...
app.patch('/jokes/:id', (req, res) => {
  ...
  const replacementJoke = {
    id: id,
    // line 64 and 65 explained: if there is new content in req body then use it or else keep the foundJoke content
